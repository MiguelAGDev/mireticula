// Lee el Excel de oferta académica y lo convierte en filas tipadas.
// Una fila del Excel == una fila de la hoja "oferta académica" del
// contexto del proyecto: una sesión de un grupo de una materia.
